...
class CipherRoundUnitTester(c: CipherRound, transform: String, SubBytes_SCD: Boolean = false) extends PeekPokeTester(c) {
  ...
  val state_out_NMC = Array(0x23, 0xbf, 0x44, 0x1b, 0xc0, 0xc2, 0xc3, 0xc5, 0xcf, 0x93, 0x48, 0x56, 0xed, 0x17, 0xa, 0x35)
  val state_out_C = Array(0xc1, 0x97, 0x3b, 0xae, 0xc2, 0xc2, 0xc9, 0xcd, 0x37, 0x7a, 0x34, 0x3b, 0xc5, 0xee, 0xb3, 0x5d)

  val state_out = transform match {
    case "AddRoundKeyOnly" => state_out_ARK
    case "NoMixColumns" => state_out_NMC
