...
class UnrolledAESUnitTester(c: UnrolledAES, Nk: Int, unrolled: Boolean, SubBytes_SCD: Boolean, InvSubBytes_SCD: Boolean, expandedKeyMemType: String) extends PeekPokeTester(c) {
...
//  }
//  poke(aes_i.io.start, 1) // reset start
//  step(1)
//
//  // remaining rounds
